function C_winsorize_BK(intermedpath,varargin)
...
if strcmp(varargin,'conservative')
    ...
    load(fullfile(intermedpath,'vectorized_images_full_masked_10_percent.mat'),'dfv_masked')
end
...
winsorized.pain_placebo=cell(size(df,1),1);
winsorized.pain_control=cell(size(df,1),1);
winsorized.placebo_minus_control=cell(size(df,1),1);
