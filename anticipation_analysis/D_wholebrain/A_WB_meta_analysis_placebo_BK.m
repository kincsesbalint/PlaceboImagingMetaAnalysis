function A_WB_meta_analysis_placebo_BK(intermedpath,pubpath, varargin)
...
results_path=fullfile(pubpath,'vectorized_results');
...
if strcmp(varargin,'conservative')
    load(fullfile(intermedpath,'vectorized_images_conservative_masked_10_percent'),'dfv_masked');
    ...
    placebo_stats=create_meta_stats_voxels_placebo_BK(df,dfv_masked,gpuon);
end
