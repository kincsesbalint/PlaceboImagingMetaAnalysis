function D_WB_meta_analysis_p_values_placebo_BK(pubpath_forvectimg,varargin)
...
if strcmp(varargin,'conservative')
    load(fullfile(pubpath_forvectimg,'WB_summary_placebo_conservative.mat'));
else
    load(fullfile(pubpath_forvectimg,'WB_summary_placebo_full.mat'));
end
%% Placebo
...
if strcmp(varargin,'conservative')
     save(fullfile(pubpath_forvectimg,'WB_summary_placebo_conservative.mat'),...
     'summary_placebo','placebo_stats','-v7.3');
else
     save(fullfile(pubpath_forvectimg,'WB_summary_placebo_full.mat'),...
     'summary_placebo','placebo_stats','-v7.3');
end
