function Atlas_et_al_2012_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
%added by BK
ratingfile=load(strcat(datapath,'\Atlas_et_al_2012\ratings\for_param_model.mat'));
...
% Unfold all variables
        ...
        %added by BK
        anticipation=zeros(size(cond));  
        anticipation(~cellfun(@isempty, regexp(cond,'Antic')))=1; % 0= NoAnticipation 1=anticipation
...
atlas.pla=pla;
atlas.pain=pain;
atlas.anticipation=anticipation;
