function Wager_et_al_2004b_Michigan_heat_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
%added by BK
anticipation(1:length(subdir),[1 2])=0;   % 0= NoPain 1=FullPain 2=EarlyPain 3=LatePain
anticipation(1:length(subdir),[3 4])=1;   % 0= NoPain 1=FullPain 2=EarlyPain 3=LatePain
...
wager_michigan.anticipation=anticipation;
