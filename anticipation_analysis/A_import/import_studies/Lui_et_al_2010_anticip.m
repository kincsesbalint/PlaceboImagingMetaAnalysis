function Lui_et_al_2010_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
anticipation(ismember(beta,[1 3]),1)=1;     
anticipation(ismember(beta,[5 7]),1)=0; 
