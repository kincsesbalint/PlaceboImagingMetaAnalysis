function Ruetgen_et_al_2015_anticip(datapath,intermedpath)
...
ruetgen.pla=pla;
ruetgen.pain=pain;
ruetgen.anticipation=zeros(size(ruetgen.img)); % the painful stimulation and anticipation was modeled together
