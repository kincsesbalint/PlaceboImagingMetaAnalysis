function Bingel_et_al_2011_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
%added by BK
anticipation=zeros(size(beta_img));
anticipation(~cellfun(@isempty,regexp(beta_img,'ant_')),1)=1; %0-no anticipation, 1-anticipation
...
%added by BK
xls_path=strcat(datapath,"/Bingel_et_al_2011/Bingel_Remi_Behavioral.xlsx");
% Gender
...
%todo find out why the x_span is important.
...
bingel11.pla=pla;
bingel11.pain=pain;
bingel11.anticipation=anticipation;
