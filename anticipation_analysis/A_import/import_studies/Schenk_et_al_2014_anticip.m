function Schenk_et_al_2014_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
anticipation=NaN(size(cond));
anticipation(~cellfun(@isempty,regexp(cond,'anti')),1)=1;  
anticipation(~cellfun(@isempty,regexp(cond,'pain')),1)=0;  
...
schenk.pla=pla;
schenk.pain=pain;
schenk.anticipation=anticipation;
