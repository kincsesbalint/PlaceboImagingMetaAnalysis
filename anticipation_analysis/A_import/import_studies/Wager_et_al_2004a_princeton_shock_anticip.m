function Wager_et_al_2004a_Princeton_shock_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
con_ID=[2;3;4;5;6];
    ...
    %Build Pain vector
        switch con_ID(i)
            ...
            case 4
            pain(j,i)=0; % 0= NoPain 1=FullPain 2=EarlyPain 3=LatePain 4=StrongVsWeakPain 5=StrongVsNoPain
            anticipation(j,i)=2; %0-no anticipation, 1-anticipation(between control-placebo), 2-anticipation (for both conditions(control+placebo)
...
wager_princeton.anticipation=anticipation;
