function Theysohn_et_al_2014_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
%added by BK
%0-no anticipation, 1-anticipation
anticipation(ismember(beta,5),1)=1;
anticipation(ismember(beta,6),1)=0;
anticipation(ismember(beta,8),1)=1;
anticipation(ismember(beta,9),1)=0;  
...
they.pla=pla;
they.pain=pain;
they.anticipation=anticipation;
