function Freeman_et_al_2015_anticip(datapath,intermedpath)
...
freeman.sub_ID=sub;
freeman.male=repmat(readtable(xls_path,"UseExcel",true,"Sheet",'BetaSummary',"DataRange",'D2:D25').Var1,4,1);
freeman.age=repmat(readtable(xls_path,"UseExcel",true,"Sheet",'BetaSummary',"DataRange",'C2:C25').Var1,4,1);
...
freeman.anticipation=zeros(size(freeman.img));
...
freeman.rating=[readtable(xls_path,"UseExcel",true,"Sheet",'BetaSummary',"DataRange",'H2:H25').Var1;...
        readtable(xls_path,"UseExcel",true,"Sheet",'BetaSummary',"DataRange",'F2:F25').Var1;...
        NaN(size(img_painHiLo));...
        NaN(size(img_painAllPrevsBL))];
