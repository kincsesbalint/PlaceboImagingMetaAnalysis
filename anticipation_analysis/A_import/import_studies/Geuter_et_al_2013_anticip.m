function Geuter_et_al_2013_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
cond=vertcat(cond(:));  
% added by BK
anticipation(ismember(con,[36 37 38 39]),1)=1; % 0= NoPain 1=FullPain 2=EarlyPain 3=LatePain
...
geuter.pla=pla;
geuter.pain=pain;
geuter.anticipation=anticipation;
