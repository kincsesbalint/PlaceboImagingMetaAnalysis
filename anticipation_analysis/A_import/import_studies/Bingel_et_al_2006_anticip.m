function Bingel_et_al_2006_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
% added by BK
anticipation=~cellfun(@isempty,regexpi(cond,'cue','match'));
...
bingel06.male=ones(size(bingel06.img))*((19-4)/19); %MISSING: Mean sex according to paper 4 female
bingel06.age=ones(size(bingel06.img))*((19-4)/19);  %MISSING: Mean age according to paper mean 24 +/-5 SEM
bingel06.healthy=ones(size(bingel06.img));
bingel06.pla=pla;
bingel06.pain=pain;
bingel06.anticipation=anticipation;
