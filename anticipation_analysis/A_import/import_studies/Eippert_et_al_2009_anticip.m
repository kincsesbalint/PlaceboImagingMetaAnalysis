function Eippert_et_al_2009_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
anticipation(~cellfun(@isempty,regexp(cond,'anticipation')),1)=1;  %0-no anticipation, 1-anticipation
...
eippert.pla=pla;
eippert.pain=pain;
eippert.anticipation=anticipation;
