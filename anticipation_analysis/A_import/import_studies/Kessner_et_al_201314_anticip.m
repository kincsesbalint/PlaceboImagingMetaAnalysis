function Kessner_et_al_201314_anticip(datapath,intermedpath)
% % --------------------------------------------------------------------
...
% added by BK
anticipation(~cellfun(@isempty,regexp(beta_img,'anticipation')),1)=1; %0-no anticipation, 1-anticipation
anticipation(~cellfun(@isempty,regexp(beta_img,'pain')),1)=0;
...
kessner.pla=pla;
kessner.pain=pain;
kessner.anticipation=anticipation;
